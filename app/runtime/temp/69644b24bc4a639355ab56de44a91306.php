<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:58:"D:\webroot\mengdie_yyg\app\www_tpl\default\ta\history.html";i:1468303703;s:57:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/base.html";i:1470730361;s:63:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/common_css.html";i:1468303703;s:61:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/tool_bar.html";i:1470730313;s:59:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/header.html";i:1468303703;s:60:"D:\webroot\mengdie_yyg\app\www_tpl\default\ta/_nav_view.html";i:1468303703;s:61:"D:\webroot\mengdie_yyg\app\www_tpl\default\ta/_base_info.html";i:1468303703;s:59:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/footer.html";i:1470726624;s:61:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/base_url.html";i:1468303703;s:62:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/common_js.html";i:1468303703;}*/ ?>
<!doctype html>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
        ...
        <div class="g-wrap">
            <div class="m-user-frame-wraper">
                ...
                <div class="m-user-frame-colNav">
                    ...
                    <h3><a href="<?php echo dwz_filter('ta/index',['uid'=>$user_info['id']]); ?>">Ta的夺宝</a></h3>
                    <hr>
                    <ul pro="userFrameNav">
                        <li class="<?php echo (ACTION_NAME=='history')?'active':''; ?>">
                            <a href="<?php echo dwz_filter('ta/history',['uid'=>$user_info['id']]); ?>" pro="userDuobao">夺宝记录 <strong pro="userDuobao_num" data-pos="userNav" class="txt-impt"></strong></a>
                        </li>
                        <li class="<?php echo (ACTION_NAME=='luck')?'active':''; ?>">
                            <a href="<?php echo dwz_filter('ta/luck',['uid'=>$user_info['id']]); ?>" pro="userWin">幸运记录 <strong pro="userWin_num" data-pos="userNav" class="txt-impt"></strong></a>
                        </li>
                        <li class="<?php echo (ACTION_NAME=='share')?'active':''; ?>">
                            <a href="<?php echo dwz_filter('ta/share',['uid'=>$user_info['id']]); ?>" pro="userShare">Ta的晒单 <strong pro="userShare_num" data-pos="userNav" class="txt-impt"></strong></a>
                        </li>
                    </ul>
                </div>
                <!--用户中心 main-->
                <div class="m-user-frame-colMain ">
                    <div class="m-user-frame-content">
                        ...
                        <div class="m-user-duobao">
                            <div class="m-user-comm-infoBox f-clear" module="user/common/infoBox/InfoBox" id="pro-view-4" module-id="module-4" module-launched="true">
    <img class="m-user-comm-infoBox-face" src="__UPLOAD_DOMAIN__<?php echo (isset($user_info['avatar']) && ($user_info['avatar'] !== '')?$user_info['avatar']:'__static__/img/avatar.jpg'); ?>" width="160" height="160">
    <div class="m-user-comm-infoBox-cont">
        <ul>
            <li class="item nickname">
                <span class="txt"><?php echo htmlspecialchars($user_info['nick_name']); ?></span>
            </li>
            <li class="item"><span class="txt">ID：<strong><?php echo htmlspecialchars($user_info['id']); ?></strong></span></li>
        </ul>
    </div>
</div>
                            <div class="m-user-comm-wraper">
                                <div module="user/duobao/DuobaoOther" class="m-user-comm-cont m-user-duobaoOther" id="pro-view-8" module-id="module-7" module-launched="true">
                                    <div class="m-user-comm-title">
                                        <div class="m-user-comm-navLandscape">
                                            <span class="title">夺宝记录</span>
                                            <a class="i-item i-item-active" pro="dNav" data-name="join" href="javascript:;">参与成功</a>
                                        </div>
                                    </div>
                                    <div id="ajax_container">
                                        <div class="listCont" data-name="multi" ajax_table="ajax_table" auto_load="auto_load" data-url="<?php echo U('ta/history_list'); ?>" data-container="ajax_container" data-param='{"page":1,"uid":<?php echo $user_info['id']; ?>}'>
                                            <div pro="userCommLoading" class="w-loading"><b class="w-loading-ico"></b><span class="w-loading-txt">正在努力加载……</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="__static__/js/ucenter/ajax_table.js"></script>
