<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:59:"D:\webroot\mengdie_yyg\app\www_tpl\default\index\index.html";i:1470731111;s:57:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/base.html";i:1470730361;s:63:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/common_css.html";i:1468303703;s:61:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/tool_bar.html";i:1470730313;s:59:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/header.html";i:1468303703;s:59:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/footer.html";i:1470726624;s:61:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/base_url.html";i:1468303703;s:62:"D:\webroot\mengdie_yyg\app\www_tpl\default\base/common_js.html";i:1468303703;}*/ ?>
<!doctype html>
<html lang="zh-cn">
<head>
    <meta charset="UTF-8">
    <title><?php echo C('WEBSITE_NAME'); ?>，一元任性买 ！</title>
...
<!--第三方验证代码-->
<?php echo C('UNION_QQ_VERIFY_CODE'); ?>
                    ...
                    <div class="g-main-l">
                        <div class="m-index-news">
                           <ul class="m-index-nl">
                               <li>
                                   <span></span>
                                   <h4><?php echo $gonggao_detail['title']; ?></h4>
                                   <p><?php echo $gonggao_detail['content']; ?></p>
                               </li>
                                ...
                                <ul class="w-slide-wrap-list" pro="list" style="width: 4380px; left: -1460px;">
                                    ...
                                    <li class="w-slide-wrap-list-item">
                                        <?php switch($each_home_promo['type']): case "1": ?>
	                                    	    <a href="<?php echo dwz_filter('goods/jump_to_goods_buying',array('gid'=>$each_home_promo['content'])); ?>" title="<?php echo htmlspecialchars($each_home_promo['title']); ?>" target="_blank"><img width="730" height="350" src="__UPLOAD_DOMAIN__<?php echo $each_home_promo['img_path']; ?>" onerror="no_img($(this));"></a>
	                                        <?php break; case "2": ?>
	                                        <a href="<?php echo $each_home_promo['content']; ?>" title="<?php echo htmlspecialchars($each_home_promo['title']); ?>" target="_blank">
	                                            <img width="730" height="350" src="__UPLOAD_DOMAIN__<?php echo $each_home_promo['img_path']; ?>"></a>
	                                        <?php break; case "3": ?>
	                                        <a href="<?php echo dwz_filter('lists/search',['keyword'=>$each_home_promo['content']]); ?>" title="<?php echo htmlspecialchars($each_home_promo['title']); ?>" target="_blank"><img width="730" height="350" src="__UPLOAD_DOMAIN__<?php echo $each_home_promo['img_path']; ?>"></a>
	                                        <?php break; endswitch; ?>
                                    </li>
                                   <!--   <?php endforeach; endif; else: echo "" ;endif; ?>  -->
                                </ul>
                                        ...
                                        <div class="w-goods-newReveal" data-status="<?php echo $each_opening['status']; ?>" data-gid="<?php echo $each_opening['goods_id']; ?>" data-nper="<?php echo $each_opening['nper_id']; ?>">
                                            ...
                                            <div class="w-goods-pic">
                                                <a href="<?php echo dwz_filter('goods/detail',['id'=>$each_opening['goods_id'].'-'.$each_opening['nper_id']]); ?>" target="_blank">
                                                    <img width="120" height="120" src="__UPLOAD_DOMAIN__<?php echo $each_opening['goods_image']; ?>" onerror="no_img($(this));">
                                                </a>
                                            </div>
                                            ...
                                            <div class="opening-result">
                                                ...
                                                <?php else: ?>
                                                <div class="w-goods-record"><p class="w-goods-owner f-txtabb">获得者：<a href="<?php echo dwz_filter('ta/index',['uid'=>$each_opening['luck_uid']]); ?>" title="ID:<?php echo $each_opening['luck_uid']; ?>">
                                                    <b><?php echo htmlspecialchars($each_opening['nick_name']); ?></b></a></p><p>本期参与：<?php echo $each_opening['luck_o_num']; ?>人次</p><p>幸运号码：<?php echo num_base_mask($each_opening['luck_num'],1); ?></p></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div class="m-index-recommend">
                        ...
                        <div class="w-goods w-goods-ing w-goods-recommend w-goods-quickBuy-warp"  data-nper="<?php echo $top_promo_one['id']; ?>" data-last="<?php echo $top_promo_one['remain']; ?>" data-unit="<?php echo $top_promo_one['unit_price']; ?>" data-min="<?php echo $top_promo_one['min_times']; ?>">
                            <div class="w-goods-pic">
                                <a href="<?php echo dwz_filter('goods/jump_to_goods_buying',['gid'=>$top_promo_one['gid']]); ?>"
                                   title="<?php echo htmlspecialchars($top_promo_one['name']); ?>" target="_blank">
                                    <img width="180" height="180" alt="" src="__UPLOAD_DOMAIN__<?php echo $top_promo_one['img_path']; ?>" onerror="no_img($(this));"
                            ...
                            <div class="w-goods-opr">
                                <a class="w-button w-button-main w-button-l w-goods-quickBuy" href="javascript:;" style="width:70px;"><?php echo C('ONE_AWARD_BTN_KEYWORDS'); ?></a>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
                                            ...
                                            <td style="border-bottom:1px dotted #C9C9C9;padding-top:15px;height:130px;text-align:center;">
                                                <a href="<?php echo dwz_filter('goods/jump_to_goods_buying',['gid'=>$each_promo_new['id']]); ?>" target="_blank">
                                                    <img width="120" height="120"
                                                         onerror="no_img($(this));"
                                                         src="__UPLOAD_DOMAIN__ <?php echo $each_promo_new['img_path']; ?>"
                    ...
                    <div class="m-index-mod m-index-goods-hotest">
                        ...
                        <div class="m-index-mod-bd">
                            <ul class="w-goodsList f-clear">
                                ...
                                <!--
                                零元样式修改
                                1. list-item    添加样式 w-goods-zero
                                2. w-button     删除style 70px
                                3. 插入    <a class="w-button w-button-main w-button-l w-goods-zero-btn" href="javascript:void(0)"  title="<?php echo C('ONE_AWARD_BTN_KEYWORDS'); ?>">零元抢宝</a>
                                -->
                                <li class='w-goodsList-item <?php if($zero_start == 1 AND !empty($each_goods['is_zero']) AND $each_goods['is_zero'] == 1): ?>w-goods-zero<?php endif; ?>' data-nper="<?php echo $each_goods['id']; ?>" data-last="<?php echo $each_goods['remain']; ?>" data-unit="<?php echo $each_goods['unit_price']; ?>" data-min="<?php echo $each_goods['min_times']; ?>">
                                    <?php if($each_goods['code'] == 'shiyuanduobao'): ?>
                                    ...
                                    <div class="w-goods w-goods-ing">
                                            ...
                                            <a href="<?php echo dwz_filter('goods/jump_to_goods_buying',['gid'=>$each_goods['gid']]); ?>" title="<?php echo htmlspecialchars($each_goods['name']); ?>"
                                               target="_blank">
                                                <img width="200" height="200" alt=""
                                                     src="__UPLOAD_DOMAIN__<?php echo $each_goods['img_path']; ?>"
                                                     onerror="no_img($(this));"
                                                     style="min-height: 40px; min-width: 40px;">
                                            </a>
                                        </div>
                                        ...
                                        <div class="w-goods-opr">
                                            <a class="w-button w-button-main w-button-l w-goods-quickBuy" href="javascript:void(0)"  title="<?php echo C('ONE_AWARD_BTN_KEYWORDS'); ?>"><?php echo C('ONE_AWARD_BTN_KEYWORDS'); ?></a>

                                            <a class="w-button w-button-main w-button-l w-goods-zero-btn" href="<?php echo U('goods/zero_detail',['gid'=>$each_goods['gid']]); ?>"  title="零元抢宝">零元抢宝</a>
                            ...
                            <ul id="one_rmb" class="w-intervalScroll" style="margin-top: 0px;">
                                ...
                                <li pro="item" class="w-intervalScroll-item <?php echo ($mod==0)?'odd':'even'; ?>">
                                    <div class="w-record-avatar">
                                        <img width="40" height="40" src="__UPLOAD_DOMAIN__<?php echo $each_legendary['avatar']; ?>" onerror="no_img($(this));">
                                    </div>
                                    <div class="w-record-detail">
                                        <p class="w-record-intro">
                                            <a class="w-record-user f-txtabb" href="<?php echo dwz_filter('ta/index',['uid'=>$each_legendary['luck_uid']]); ?>" target="_blank"
                                               title="ID:<?php echo $each_legendary['luck_uid']; ?>"><?php echo htmlspecialchars($each_legendary['nick_name']); ?></a>
                                            <span class="w-record-date"><?php echo microtime_format($each_legendary['luck_time'],'1','于m月d日'); ?></span>
                                        </p>
                                        <p class="w-record-title f-txtabb"><strong><?php echo $each_legendary['num']; ?>人次</strong>夺得
                                            <a title="<?php echo htmlspecialchars($each_legendary['goods_name']); ?>"
                                               href="
                                               <?php echo dwz_filter('goods/detail',array('id'=>$each_legendary['gid'].'-'.$each_legendary['nper_id'])); ?>"
            ...
            <div class="g-wrap g-body-ft f-clear">
                                ...
                                <li pro="item" class="w-slide-wrap-list-item  ">
                                    ...
                                    <a href="<?php echo dwz_filter('goods/jump_to_goods_buying',array('gid'=>$category_promo[$each_category['id']]['gid'])); ?>" target="_blank">
                                        ...
                                        <a href="<?php echo $category_promo[$each_category['id']]['url']; ?>" target="_blank">
                                            <?php endif; ?>
                                            <img width="239" height="400" src="__UPLOAD_DOMAIN__<?php echo $category_promo[$each_category['id']]['img_path']; ?>" onerror="no_img($(this));">
                                        </a>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <li class='w-goodsList-item <?php if($zero_start == 1 AND !empty($each_goods['is_zero']) AND $each_goods['is_zero'] == 1): ?>w-goods-zero<?php endif; ?>' data-nper="<?php echo $each_goods['id']; ?>" data-last="<?php echo $each_goods['remain']; ?>" data-unit="<?php echo $each_goods['unit_price']; ?>" data-min="<?php echo $each_goods['min_times']; ?>">
                                <div class="w-goods w-goods-ing">
                                    ...
                                    <p class="w-goods-title f-txtabb">
                                        <a title="<?php echo htmlspecialchars($each_goods['sub_title']); ?>" href="<?php echo dwz_filter('goods/jump_to_goods_buying',['gid'=>$each_goods['gid']]); ?>"
                                           target="_blank"><?php echo htmlspecialchars($each_goods['name']); ?>
                                        </a>
                                    </p>
                                    <p class="w-goods-price">总需：<?php echo $each_goods['sum_times']; ?> 人次</p>
                                    <div class="w-progressBar" title="<?php echo $each_goods['percent']; ?>%">
                                ...
                                <div class="w-goods w-goods-ing">
                                    ...
                                    <div class="w-goods-opr">
                                        ...
                                        <a class="w-button w-button-main w-button-l w-goods-quickBuy"
                                           href="javascript:void(0)" style="width:70px;" title="<?php echo C('ONE_AWARD_BTN_KEYWORDS'); ?>"><?php echo C('ONE_AWARD_BTN_KEYWORDS'); ?></a>
                                        <a class="w-button w-button-addToCart" href="javascript:void(0)"
                                           title="添加到购物车"></a>
                                    </div>
                                </div>
                ...
                <div class="m-index-mod m-index-share">
                    <div class="w-hd">
                        ...
                        <a class="w-hd-more" href="/share.html">更多分享，点击查看&gt;&gt;</a>
                    </div>
                    <div class="m-index-mod-bd">
                        <ul class="w-intervalScroll f-clear" data-minline="4" data-perline="2" id="pro-view-12"
                            ...
                            <li pro="item" class="w-intervalScroll-item <?php echo ($mod==0)?'left':'right'; ?>">
                                <a class="m-index-share-picLink" href="<?php echo dwz_filter('share/detail',['id'=>$each_share['id']]); ?>" target="_blank">
                                    <img class="m-index-share-pic" width="110" src="__UPLOAD_DOMAIN__<?php echo (isset($each_share['share_image']) && ($each_share['share_image'] !== '')?$each_share['share_image']:'__noimg__'); ?>" onerror="no_img($(this));">
                                </a>
                                <div class="m-index-share-wrap">
                                    ...
                                    <p class="author">—— <a title="<?php echo $each_share['username']; ?>(ID:<?php echo $each_share['uid']; ?>)"
                                                            ...
                                                            target="_blank"><?php echo $each_share['nick_name']; ?></a> <?php echo date('Y-m-d H:i:s',$each_share['create_time']); ?></p>
...
<input type="hidden" id="join_history_link" value="<?php echo U('index/join_history'); ?>" />
...
<script type="text/javascript" src="__static__/js/count.js"></script>
