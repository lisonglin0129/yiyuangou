<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:54:"D:\webroot\mengdie_yyg\app\admin\view\goods\index.html";i:1468303702;s:52:"D:\webroot\mengdie_yyg\app\admin\view\base/base.html";i:1468303702;s:58:"D:\webroot\mengdie_yyg\app\admin\view\base/common_css.html";i:1468303702;s:54:"D:\webroot\mengdie_yyg\app\admin\view\base/navbar.html";i:1468303702;s:57:"D:\webroot\mengdie_yyg\app\admin\view\base/common_js.html";i:1468303702;s:56:"D:\webroot\mengdie_yyg\app\admin\view\base/base_url.html";i:1468303702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<link rel="stylesheet" type="text/css" href="__plugin__/lightbox/lightbox.min.css" />
...
<input type="hidden" id="http_host" value="http://<?php echo $_SERVER['HTTP_HOST']; ?>">
<input type="hidden" id="down_url" value="<?php echo U('down_pic'); ?>">
<input type="hidden" id="qr_url" value="<?php echo U('core/api/qr_code'); ?>">
<input type="hidden" id="del_url" value="<?php echo U('del'); ?>">
<input type="hidden" id="del_nper_url" value="<?php echo U('del_nper'); ?>">
<input type="hidden" id="trigger_open_url" value="<?php echo U('core/gdfc/init_new_nper'); ?>">
<input type="hidden" id="del_select" value="<?php echo U('del_select'); ?>">
...
<script type="text/javascript" src="__common__/plugin/copy/jquery.zclip.min.js"></script>
<script type="text/javascript" src="__common__/plugin/lightbox/lightbox.min.js"></script>
<script type="text/javascript" src="__common__/admin/js/goods/index.js"></script>
