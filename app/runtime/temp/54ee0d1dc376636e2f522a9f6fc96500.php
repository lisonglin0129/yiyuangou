<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:59:"D:\webroot\mengdie_yyg\app\admin\view\zero\win_records.html";i:1468303702;s:52:"D:\webroot\mengdie_yyg\app\admin\view\base/base.html";i:1468303702;s:58:"D:\webroot\mengdie_yyg\app\admin\view\base/common_css.html";i:1468303702;s:54:"D:\webroot\mengdie_yyg\app\admin\view\base/navbar.html";i:1468303702;s:57:"D:\webroot\mengdie_yyg\app\admin\view\base/common_js.html";i:1468303702;s:56:"D:\webroot\mengdie_yyg\app\admin\view\base/base_url.html";i:1468303702;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <div class="col-xs-8">
                    <div class="row">
                        <div class="col-xs-2" style="min-width: 120px">
                            <select class="form-control" id="form-field-select-1" name="luck_type" >
                                <option value="">全部</option>
                                <option value="1">商品中奖</option>
                                <option value="2"><?php echo C('MONEY_NAME'); ?>中奖</option>
                            </select>
                        </div>
                        <div class="col-xs-2" style="min-width: 120px">
                            <select class="form-control" id="search_condition" name="search_type" >
                        ...
                        <div class="col-xs-6">
                            <div class="input-group">
                                <input class="form-control search-query fc-input" style="min-width: 120px" placeholder="请输入" type="text" name="keywords">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <div id="form_content" data-url="<?php echo U('win_records_list'); ?>"></div>
