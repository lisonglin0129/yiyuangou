<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"D:\webroot\mengdie_yyg\app\core\view\pay\cart_list_div.html";i:1468303702;}*/ ?>
    ...
    <ul pro="list" class="w-miniCart-list">
        ...
        <li class="w-miniCart-item" id="pro-view-27">
            ...
            <div class="w-miniCart-item-text">
                ...
                <p><em><?php if(!empty($vo['unit_price'])): echo (int)$vo['unit_price'].C('MONEY_UNIT').C('MONEY_NAME'); else: ?>--<?php endif; ?>&times; <?php echo (isset($vo['num']) && ($vo['num'] !== '')?$vo['num']:'--'); ?>次参与( 期数:
                    <?php echo (num_base_mask($vo['nper_id']) !== ''?num_base_mask($vo['nper_id']):'--'); ?>)</em><a data-nper="<?php echo $vo['nper_id']; ?>" data-id="<?php echo (isset($vo['id']) && ($vo['id'] !== '')?$vo['id']:''); ?>" class="w-miniCart-item-del del_cart_btn" href="javascript:void(0);" pro="del">删除</a></p>
            </div>
        </li>
...
<div pro="footer" class="w-miniCart-layer-footer" id="pro-view-29">
    <p><strong>共有<b pro="count"><?php echo (isset($count) && ($count !== '')?$count:'0'); ?></b>件商品，金额总计：<em><span pro="amount"><?php echo (isset($sum_money) && ($sum_money !== '')?$sum_money:'0'); ?></span><?php echo C('MONEY_UNIT'); echo C('MONEY_NAME'); ?></em></strong></p>
    <p>
