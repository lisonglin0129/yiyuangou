...
class Wechat
{
   ...
   // const MCH_SEND_PACKET='https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack';
    ...
    public function curl_post_ssl( $vars, $second=120,$aHeader=array(),$cert_pem,$key_pem,$ca_pem)
    {
        $ch = curl_init();
        //超时时间
