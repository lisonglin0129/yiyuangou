...
//        }
        ...
        $keysArr = array(
            ...
            "client_id" =>!empty($this->config['appid'])?$this->config['appid']:$this->recorder->readInc("appid"),
            "redirect_uri" => !empty($this->config['callback'])?$this->config['callback']:urlencode($this->recorder->readInc("callback")),
            "client_secret" =>!empty($this->config['appsec'])?$this->config['appsec']:$this->recorder->readInc("appkey"),
            "code" => $_GET['code']
        );
